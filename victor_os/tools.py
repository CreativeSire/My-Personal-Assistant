...
def transcribe_audio_file(file_path: str) -> str:
    ...
    Preferred: local Whisper (if installed).
    ...
    try:
        ...
        # Keep fallbacks available if Whisper fails at runtime.
        logger.warning(f"Whisper transcription failed; falling back: {e}", extra={"tool_name": "transcribe_audio_file"})
...
# --- TOOL 9: THE EAR (Active Window) ---
def get_active_window() -> str:
    """Returns the title and process name of the currently focused window on the user's PC."""
    try:
        import win32gui
        import win32process
        import psutil
...
# --- TOOL 10: THE HAND (Clipboard) ---
def read_clipboard() -> str:
    """Returns the current contents of the user's clipboard."""
    try:
        import pyperclip
